...
public class COTSTalonFXSwerveConstants {
    ...
    public static final class WCP {
        ...
        public static final class SwerveXFlipped{
            /** West Coast Products - SwerveX Flipped (Kraken mk4i)*/
            public static final COTSTalonFXSwerveConstants Kraken mk4i(double driveGearRatio){
                double wheelDiameter = Units.inchesToMeters(4.0);
    ...
    public static final class SDS {
        ...
        public static final class MK3{
            /** Swerve Drive Specialties - MK3 Module (Kraken mk4i)*/
            public static final COTSTalonFXSwerveConstants Kraken mk4i(double driveGearRatio){
                double wheelDiameter = Units.inchesToMeters(4.0);
        ...
        public static final class MK4{
            /** Swerve Drive Specialties - MK4 Module (Kraken mk4i)*/
            public static final COTSTalonFXSwerveConstants Kraken mk4i(double driveGearRatio){
                double wheelDiameter = Units.inchesToMeters(4.0);
